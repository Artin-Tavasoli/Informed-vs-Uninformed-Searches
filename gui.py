...
from SearchFunctions import solver_bfs, solver_dfs, solver_ids, solver_astar, solver_astar2, solver_astar3, solver_astar4
...
def draw_mode_menu(selected_mode):
    ...
    last_y = 80 + len(modes) * 30
    rl.draw_text("Press ENTER to start game", 50, last_y + 30, 20, rl.BLACK)
